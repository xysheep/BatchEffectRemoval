...
class MMD:
    ...
    def __init__(self,
        ...
        MMDTargetTrain, MMDTargetValidation = train_test_split(
            MMDTargetTrain, test_size=MMDTargetValidation_split, random_state=42)
        ...
        self.MMDTargetValidationSize = K.eval(
            K.shape(self.MMDTargetValidation)[0])
    ...
    def KerasCost(self, y_true, y_pred):
        ...
        MMDtargetSample = K.in_train_phase(
            MMDTargetSampleTrain, MMDTargetSampleValidation)
